...
//HID Panel for RCB PANEL
#include <Joystick.h>
#define NUMBUTTONS 11     // match to number of pins being used for HID

// defining the total [#] of buttons and their pins
int SwitchOnPin[NUMBUTTONS] = {A0,5,4,7,6,9,8,16,10,15,14};    //add other pins here
//Store States
