...
DcsBios::Potentiometer ampcdBrtCtl("AMPCD_BRT_CTL", A7);

DcsBios::Switch3Pos leftDdiCrsSw("LEFT_DDI_CRS_SW", A0, A1);
DcsBios::Switch3Pos leftDdiHdgSw("LEFT_DDI_HDG_SW", A3, A2);
